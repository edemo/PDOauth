...
#    ANCHOR_URL = "https://anchor.edemokraciagep.org/"
    ...
    CHANGE_EMAIL_DONE_EMAIL_SUBJECT = "warnemail address change has been requested"
    CHANGE_EMAIL_DONE_EMAIL_BODY_TEXT = "warnDear {0.name}"
    CHANGE_EMAIL_DONE_EMAIL_BODY_HTML = "warnhtml {0.name}"
    CHANGE_EMAIL_OLD_EMAIL_SUBJECT = "oldemail address change has been requested"
    CHANGE_EMAIL_OLD_EMAIL_BODY_TEXT = "oldDear {0.name}, {0.secret}, {0.expiry}"
    CHANGE_EMAIL_OLD_EMAIL_BODY_HTML = "oldhtml {0.name}, {0.secret}, {0.expiry}"
    CHANGE_EMAIL_NEW_EMAIL_SUBJECT = "new email address change has been requested"
    CHANGE_EMAIL_NEW_EMAIL_BODY_TEXT = "newDear {0.name}, {0.secret}, {0.expiry}"
    CHANGE_EMAIL_NEW_EMAIL_BODY_HTML = "newhtml {0.name}, {0.secret}, {0.expiry}"

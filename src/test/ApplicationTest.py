...
class ApplicationTest(Fixture):
    ...
    def the_name_of_the_application_must_be_unique(self):
        self.assertRaises(NotUnique,Application.new,"test app1", "secret2","https://test.app/redirecturi1")

    @test 
    def the_redirect_uri_of_the_application_must_be_unique(self):
        self.assertRaises(NotUnique,Application.new,"test app1", "secret1", "https://test.app/redirecturi2")

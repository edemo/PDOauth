...
class EmailTest(PDUnitTest, EmailUtil):
    ...
    def test_email_is_formatted_correctly(self):
    ...
    def test_password_reset_email_subject_is_PASSWORD_RESET_EMAIL_SUBJECT(self):
        self.mailer.sendPasswordResetMail(self.user)
        self.assertSubjectIs("password reset")

    
    def test_password_reset_email_body_is_DEREGISTRATION_EMAIL_BODY(self):
        self.mailer.sendPasswordResetMail(self.user)
        self.assertGotAnEmailContaining("This is a reset email")

    
    def test_password_reset_email_body_contains_user(self):
        self.mailer.sendPasswordResetMail(self.user)
    ...
    def test_password_verification_email_subject_is_PASSWORD_VERIFICATION_EMAIL_SUBJECT(self):
        self.mailer.sendPasswordVerificationEmail(self.user)
        self.assertSubjectIs("verification")

    
    def test_password_verification_email_body_is_DEREGISTRATION_EMAIL_BODY(self):
        self.mailer.sendPasswordVerificationEmail(self.user)
        self.assertGotAnEmailContaining("This is a verification email")

    
    def test_password_verification_email_body_contains_user(self):
        self.mailer.sendPasswordVerificationEmail(self.user)
        self.assertGotAnEmailContaining(self.user.email)
    ...
    def test_deregistration_email_subject_is_DEREGISTRATION_EMAIL_SUBJECT(self):
        self.mailer.sendDeregisterMail(self.user)
        self.assertSubjectIs("deregistration email")

    
    def test_deregistration_email_body_is_DEREGISTRATION_EMAIL_BODY(self):
        self.mailer.sendDeregisterMail(self.user)
        self.assertGotAnEmailContaining("This is a deregistration email")

    
    def test_deregistration_email_body_contains_user(self):
        self.mailer.sendDeregisterMail(self.user)
        self.assertGotAnEmailContaining(self.user.email)
    ...
    def test_verification_email_smtp_error_throws_ReportedError_and_removes_user(self):
    ...
    def test_password_reset_email_smtp_error_throws_ReportedError(self):
        email = self.user.email
        with self.assertRaises(ReportedError):
    ...
    def test_deregistration_email_smtp_error_throws_ReportedError(self):
        email = self.user.email
        with self.assertRaises(ReportedError):
    ...
    def test_ReportedError_contains_localizable_message_and_original_error(self):
